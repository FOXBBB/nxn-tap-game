...
(function () {
  ...
  const steps = {
    EN: [
      ...
      { screen: "main", title: "Stake", text: "Stake NXN to earn rewards every cycle." },
      { screen: "main", title: "Finish", text: "Play, stake and earn NXN!" }
    ],
    RU: [
      { screen: "main", title: "Тап", text: "Нажимай на монету и зарабатывай NXN.", target: "#coin" },
      { screen: "main", title: "Энергия", text: "Каждый тап тратит энергию.", target: "#energy" },
      ...
      { screen: "main", title: "Стейк", text: "Стейк — участие в наградах." },
      { screen: "main", title: "Готово", text: "Играй и зарабатывай NXN!" }
    ],
    TR: [
      { screen: "main", title: "Dokun", text: "Coin'e dokunarak NXN kazan.", target: "#coin" },
      { screen: "main", title: "Enerji", text: "Her dokunuş enerji harcar.", target: "#energy" },
      ...
      { screen: "main", title: "Stake", text: "Ödüller için stake et." },
      { screen: "main", title: "Bitti", text: "Oyna ve kazan!" }
    ]
  };
